    ...
    <div>
      <div className="container flex md:flex-row flex-col-reverse p-3 md:p-20 gap-12">
        <div className='text-left font-mono md:p-20 py-5 px-1 shadow-lg rounded'>
          ...
          <p className='py-4 text-xl md:mb-5'>RRR is the one of the big project of SS Rajamoli , he spends 4 year in this project with very high budget , he cast two popular south indian actor in lead roles with one A-listed bollywood actor in cameo.</p>
